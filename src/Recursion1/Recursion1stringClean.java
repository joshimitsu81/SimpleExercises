...
//		int convint2 =	Integer.parseInt(input2);
	 System.out.println(stringClean("fb11cgr111abckj"));
	}
	
	public static String stringClean(String str)	{
      int len = str.length();
      if (len<2) return str;
      char thisone = str.charAt(0);
      if (thisone==str.charAt(1)) return stringClean(str.substring(1,len));
      return thisone + stringClean(str.substring(1,len));
	}
}
