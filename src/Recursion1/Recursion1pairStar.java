...
//		int convint2 =	Integer.parseInt(input2);
	...
	public static String pairStar(String str)	{
      int len = str.length();
      if (len<2) return str;
      char thiscar = str.charAt(0);
      char nextcar = str.charAt(1);
      String nextstr = pairStar(str.substring(1,len));
      if (thiscar==nextcar) return thiscar + "*" + nextstr;
      return thiscar + nextstr;
	}
}
