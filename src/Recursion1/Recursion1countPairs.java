...
//		int convint2 =	Integer.parseInt(input2);
	 System.out.println(countPairs("axabx"));
	}
	...
	public static int countPairs(String str)	{
      ...
      char pairchar = str.charAt(2);
      if (thischar==pairchar) return 1 + countPairs(str.substring(1,len));
      return countPairs(str.substring(1,len));
	}
}
